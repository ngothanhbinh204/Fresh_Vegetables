            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="../../public/image/banner/hero-bg.jpg" alt="sing up image"></figure>
                    ...
                    <div class="signin-form">
                        ...
                        <form action="/xl_login" method="POST" class="register-form" id="login-form">

                            <div class="form-group">
                                <label for="your_name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input name="username" type="text" id="your_name" placeholder="Your Name" />
                            </div>
                            <div class="form-group">
                                <label for="your_pass"><i class="zmdi zmdi-lock"></i></label>
                                <input name="password" type="password" id="your_pass" placeholder="Password" />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group form-button">
                                <input name="button_login" type="submit" id="signin" class="form-submit" value="Log in" />
                            </div>
